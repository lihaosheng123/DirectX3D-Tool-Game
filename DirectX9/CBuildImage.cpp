...
//  戻り値　：HRESULT
//=============================================================================
HRESULT CBuildImage::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
...
//  戻り値　：
//=============================================================================
void CBuildImage::Update(void)
{
	CManager *manager = GetManager();
	CSceneInput *m_Input = manager->GetInput();
}

CBuildImage* CBuildImage::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
	CBuildImage *m_BuildImage;
	m_BuildImage = new CBuildImage;
	m_BuildImage->Init(pos, rot, height, width, TEXTURE_FILE);
	return m_BuildImage;
}
