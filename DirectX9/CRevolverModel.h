/********************************************************************************
* タイトル　01
* ファイル名　CRevolverModel.h
* 作成者 AT13B284 42 李昊盛
* 作成日 2016/08/23
* ``Xポリゴン描画
********************************************************************************/
#ifndef _CREVOLVERMODEL_H_
#define _CREVOLVERMODEL_H_
...
public:
	...
	static CRevolverModel* Create(LPCSTR TEXTURE_FILE);//生成関数
private:
	...
	CRevolverModel *m_Parent;
	D3DXVECTOR3 m_scl;        // スケール値
	D3DXMATRIX GetWorldMatrix(void);
	void SetParent(CRevolverModel *Parent);
