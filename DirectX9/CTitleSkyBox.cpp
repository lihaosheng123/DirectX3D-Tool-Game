...
//  戻り値　：HRESULT
//=============================================================================
HRESULT CTitleSkyBox::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
	...
	D3DXCreateTextureFromFile(device, "data\\TEXTURE\\sea_lf.JPG", &m_pTexture[0]);

	D3DXCreateTextureFromFile(device, "data\\TEXTURE\\sea_bk.JPG", &m_pTexture[1]);

	D3DXCreateTextureFromFile(device, "data\\TEXTURE\\sea_rt.JPG", &m_pTexture[2]);

	D3DXCreateTextureFromFile(device, "data\\TEXTURE\\sea_ft.JPG", &m_pTexture[3]);

	D3DXCreateTextureFromFile(device, "data\\TEXTURE\\sea_up.JPG", &m_pTexture[4]);

	D3DXCreateTextureFromFile(device, "data\\TEXTURE\\sea_dn.JPG", &m_pTexture[5]);
...
//------------------------------------------------------------------------------
//	関数名:	void CTitleSkyBox::Draw
//	引数:	なし
//	戻り値:	なし
//	説明:	描画処理
//------------------------------------------------------------------------------
void CTitleSkyBox::Draw(void)
{
...
//------------------------------------------------------------------------------
//	関数名:	void CTitleSkyBox::Update
//	引数:	なし
//	戻り値:	なし
//	説明:	描画処理
//------------------------------------------------------------------------------
void CTitleSkyBox::Update(void)
{
	//  デバイスのゲッター
...
CTitleSkyBox* CTitleSkyBox::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
	CTitleSkyBox *m_TitleSkyBox;
	m_TitleSkyBox = new CTitleSkyBox;
	m_TitleSkyBox->Init(pos, rot, height, width, TEXTURE_FILE);
	return m_TitleSkyBox;
}