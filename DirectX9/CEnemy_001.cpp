...
//  戻り値　：HRESULT
//=============================================================================
HRESULT CEnemy_001::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
...
//------------------------------------------------------------------------------
//	関数名:	void CEnemy_001::Draw
//	引数:	なし
//	戻り値:	なし
//	説明:	描画処理
//------------------------------------------------------------------------------
void CEnemy_001::Draw(void)
{
	CManager *manager = GetManager();
...
//------------------------------------------------------------------------------
//	関数名:	void CEnemy_001::Update
//	引数:	なし
//	戻り値:	なし
//	説明:	描画処理
//------------------------------------------------------------------------------
void CEnemy_001::Update(void)
{
	CManager *manager = GetManager();
	CGame *game = (CGame*)CManager::GetMode();
	...
	switch (m_type)
	{
	case CEnemy_001::ENEMY_001_BUILDING_FRONT:
		m_Enemy_001->m_Position.x = (int)m_NumCheck.x;	// 頂点座標
		m_Enemy_001->m_Position.z = (int)m_NumCheck.z;
		m_Enemy_001->m_Position.y = (int)m_NumCheck.y;
		m_Enemy_001->m_Rotation = D3DXVECTOR3(0.0f, 0.0f, 0.0f);

		break;
	case CEnemy_001::ENEMY_001_BUILDING_BACK:
		m_Enemy_001->m_Position.x = (int)m_NumCheck.x;	// 頂点座標
		m_Enemy_001->m_Position.z = (int)m_NumCheck.z;
		m_Enemy_001->m_Position.y = (int)m_NumCheck.y;
		m_Enemy_001->m_Rotation = D3DXVECTOR3(0.0f, 3.14f, 0.0f);

		break;
	case CEnemy_001::ENEMY_001_BUILDING_LEFT:
		m_Enemy_001->m_Position.x = (int)m_NumCheck.x;	// 頂点座標
		m_Enemy_001->m_Position.z = (int)m_NumCheck.z;
		m_Enemy_001->m_Position.y = (int)m_NumCheck.y;
		m_Enemy_001->m_Rotation = D3DXVECTOR3(0.0f, -1.57f, 0.0f);

		break;
	case CEnemy_001::ENEMY_001_BUILDING_RIGHT:
		m_Enemy_001->m_Position.x = (int)m_NumCheck.x;	// 頂点座標
		m_Enemy_001->m_Position.z = (int)m_NumCheck.z;
		m_Enemy_001->m_Position.y = (int)m_NumCheck.y;
		m_Enemy_001->m_Rotation = D3DXVECTOR3(0.0f, 1.57f, 0.0f);
		...
		break;
	case CEnemy_001::ENEMY_001_BUILDING_FALSE:
		m_Enemy_001->m_Position.x =	5000.0f;
		m_Enemy_001->m_Position.z = 5000.0f;
		m_Enemy_001->m_Position.y = 5000.0f;

		break;
	case CEnemy_001::ENEMY_001_MAX:
		break;
	default:
		break;
	}
...
CEnemy_001* CEnemy_001::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
	CEnemy_001 *Enemy_001;
	Enemy_001 = new CEnemy_001;
	Enemy_001->Init(pos, rot, height, width, TEXTURE_FILE);
	return Enemy_001;
}