...
HRESULT CStart::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
	...
	// モデルの初期設定
	m_Position = m_BuildLoadMap->m_Pos_Start[0];	// 頂点座標
