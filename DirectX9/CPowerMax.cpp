...
//  戻り値　：HRESULT
//=============================================================================
HRESULT CPowerMax::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
...
CPowerMax* CPowerMax::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
	CPowerMax *m_PowerMax;
	m_PowerMax = new CPowerMax;
	m_PowerMax->Init(pos, rot, height, width, TEXTURE_FILE);
	return m_PowerMax;
}
