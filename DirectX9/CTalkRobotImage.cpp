...
// クラスコンストラクタ
//=============================================================================
CTalkRobotImage::CTalkRobotImage()
{
	m_pTexture = NULL;
...
//  戻り値　：HRESULT
//=============================================================================
HRESULT CTalkRobotImage::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
...
//  戻り値　：
//=============================================================================
void CTalkRobotImage::Uninit(void)
{
	RELEASE(m_pTexture);
...
//  戻り値　：
//=============================================================================
void CTalkRobotImage::Draw(void)
{
	CManager *manager = GetManager();
...
//  戻り値　：
//=============================================================================
void CTalkRobotImage::Update(void)
{
	CManager *manager = GetManager();
...
CTalkRobotImage* CTalkRobotImage::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE)
{
	CTalkRobotImage *m_TalkRobotImage;
	m_TalkRobotImage = new CTalkRobotImage;
	m_TalkRobotImage->Init(pos, rot, height, width, TEXTURE_FILE);
