...
#define	TEXTURE_POWERPOLY_FILE		"data\\TEXTURE\\PowerPoly.png"	// 読み込むテクスチャファイル名
...
public:
	...
	static CPowerPoly* Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, float height, float width, LPCSTR TEXTURE_FILE);//生成関数
};
#endif