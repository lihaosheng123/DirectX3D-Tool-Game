...
//  戻り値　：HRESULT
//=============================================================================
HRESULT CResultbg ::Init(D3DXVECTOR3 pos, D3DXVECTOR3 rot,float height ,float width,LPCSTR TEXTURE_FILE)
{
...
void CResultbg :: Update(void)
{
	...
	if(m_Input->GetKeyboardPress(DIK_DELETE))
	{
		Uninit();
		Release();
	}
...
CResultbg* CResultbg::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot,float height ,float width,LPCSTR TEXTURE_FILE)
{
	CResultbg *m_titlebg;
	m_titlebg = new CResultbg;
	m_titlebg->Init(pos,rot,height ,width,TEXTURE_FILE);
	return m_titlebg;
}
