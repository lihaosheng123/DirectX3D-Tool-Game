...
// 説明 
//================================================================================================================================================================================================
HRESULT CModel::Init(LPCSTR TEXTURE_FILE)
{
	...
	D3DXCreateTextureFromFile(device, "data\\TEXTURE\\MobileAtlas.png", &m_pTexture);// テクスチャ読み込み
		// Xファイルの読み込み
...
CModel* CModel::Create(LPCSTR TEXTURE_FILE)
{
	CModel *sceneX;
	sceneX = new CModel;
